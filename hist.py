...
print(np.where(y_next_sim6507.iloc[0]!=y_sim6507.iloc[0]))
print(np.where(y_next_sim6507.iloc[1]!=y_sim6507.iloc[1]))
...
# axs2[1].hist(label_2_tia,bins =2661)
