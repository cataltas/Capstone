...
if __name__ == "__main__":
    ...
    if data_size=='full':
        plt.savefig('full_loss_hdim{}_bs{}_ep{}_lr{}.png'.format(hidden_dim,bsize,ep,LR))
    else:
    ...
    if data_size=='full':
        plt.savefig('full_iterative_losses_hdim{}_bs{}_ep{}_lr{}.png'.format(hidden_dim, bsize, ep, LR))
    else:
